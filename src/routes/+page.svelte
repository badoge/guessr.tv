      ...
      <div class="modal-body">
        <div class="card border mb-3">
          ...
          <div class="card-body">
            ...
            Every 30 minutes a bot fetches live channels from the Twitch API to make the channel list. The answer is updated using the API just before starting the game but it can still be
            off because the API is not as accurate view count on the embedded stream. Some channels might also have gone offline during the time it takes the API to update.<br />

            <br />
            You might encounter a "Preparing your stream..." screen at the start of each round, to get rid of them you can subscribe to Twitch Turbo or change the video type to clips or get a
            better Adblocker :)<br />
